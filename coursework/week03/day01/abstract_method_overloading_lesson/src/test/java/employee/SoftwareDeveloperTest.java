...
public class SoftwareDeveloperTest {
    private Software_Developer sd;

    @BeforeEach
    public void setUp(){
        Company company = new Company();
        sd = new Software_Developer("John Cena", 3244543, 45000, company);
    ...
    public void canPullTask(){
        ...
        sd.work(new SoftwareTask("Make me a new great game"));
        assertThat(sd.employer.getSoftwareBackLog().size()).isEqualTo(3);
    }
